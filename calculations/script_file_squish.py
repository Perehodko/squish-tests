...
def all():
    global route_b, main_b, measure_b, measure_two_point_b
    global okButton
    ...
    #  Главное меню
    main_b = "{name='m_btnMain' type='QPushButton' visible='1' window=':mainWidget_gui::AnimatedStackedWidget'}" #Кнопка "Основной"
    measure_b = "{occurrence='7' type='QPushButton' unnamed='1' visible='1' window=':mainWidget_gui::AnimatedStackedWidget'}"  # Измерения
    measure_two_point_b = "{occurrence='10' type='QPushButton' unnamed='1' visible='1' window=':mainWidget_gui::AnimatedStackedWidget'}"  # Расстояние между двумя точками
